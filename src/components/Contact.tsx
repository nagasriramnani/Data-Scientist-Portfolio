...
export default function Contact() {
    return (
        <footer className="bg-transparent pt-24 pb-12 px-6 md:px-16 relative z-20 border-t border-white/5 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-2xl h-64 bg-[#FF5A1F] opacity-[0.03] blur-[120px] pointer-events-none rounded-full" />
            ...
            <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12 relative z-10">
                ...
                >
                    <a
                        ...
                        className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-[#FF5A1F] rounded-full text-white font-medium transition-all duration-300 backdrop-blur-md overflow-hidden"
                    >
                        ...
                        <Mail className="w-5 h-5 group-hover:scale-110 transition-transform group-hover:text-[#FF5A1F]" />
                        Say Hello
                    </a>

                    <div className="flex gap-4 mt-2">
                        <a href="https://github.com/nagasriramnani" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:border-[#FF5A1F] hover:bg-[#FF5A1F]/10 text-neutral-400 hover:text-white transition-all duration-300">
                            <Github className="w-5 h-5" />
                        </a>
                        <a href="https://linkedin.com/in/naga-sri-ram-kochetti-72a464189" target="_blank" rel="noreferrer" className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:border-[#FF5A1F] hover:bg-[#FF5A1F]/10 text-neutral-400 hover:text-white transition-all duration-300">
